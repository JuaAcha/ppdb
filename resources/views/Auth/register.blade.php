...
<body>
    ...
    <!-- General JS Scripts -->
    <script src="{{asset ('assetz/modules-js/jquery.min.js')}}"></script>
    <script src="{{asset ('assetz/modules-js/popper.js')}}"></script>
    <script src="{{asset ('assetz/modules-js/tooltip.js')}}"></script>
    <script src="{{asset ('assetz/modules-js/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{asset ('assetz/modules-js/nicescroll/jquery.nicescroll.min.js')}}"></script>
    <script src="{{asset ('assetz/modules-js/moment.min.js')}}"></script>
    <script src="{{asset ('assetz/modules-js/stisla.js')}}"></script>
